        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center space-y-3">
            ...
            <h1 className="text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">
              Create your FinOps Workspace
            </h1>
            <p className="text-xs text-slate-600 dark:text-zinc-400 font-medium">
              Establish a new isolated multi-tenant organization
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200 shadow-xl dark:bg-[#121215] dark:border-zinc-800/90 rounded-2xl p-7 dark:shadow-2xl dark:shadow-black/80 relative transition-colors duration-200">
            ...
            <form className="space-y-4" onSubmit={handleRegister}>
              ...
              <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 dark:bg-[#09090b] dark:border-zinc-800 space-y-1.5 text-xs text-slate-600 dark:text-zinc-400">
                <div className="flex items-center gap-1.5 text-emerald-600 dark:text-emerald-400 font-semibold">
                  <CheckCircle2 className="w-3.5 h-3.5" />
                  <span>Automatic Tenant Organization Creation</span>
                </div>
                <p>Registering assigns your account the <strong className="text-slate-800 dark:text-zinc-200">OWNER</strong> role with full administration rights.</p>
              </div>
